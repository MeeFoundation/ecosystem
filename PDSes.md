...
| DIF                                       | [Identity Hub](https://identity.foundation/identity-hub/spec/) |                                  | "Identity Hubs are a data storage and message relay mechanism entities can use to locate public or private permissioned data related to a given Decentralized Identifier (DID)" | [GitHub](https://github.com/decentralized-identity/identity-hub) |  -   | -    | -    |      |      | ●    | [Identity Hub](https://identity.foundation/identity-hub/spec/) |            |
